 ...
 * 1. no parameters - creates an instance of AQAWriteTextFile2018
 *
 ...
 *
 */
public class AQAWriteTextFile2018 {
  ...
  } // end constructor AQAWriteTextFile2018

  /**
   * Constructor - filename is opened to write at the start of the file
   * @param filename  name of file to be opened
   */
  AQAWriteTextFile2018(String filename) {
   ...
   */
  AQAWriteTextFile2018(String filename, boolean append) {
